...
import { db, storage } from '../../Firebase'; // Firebase configurations

const BeardTable = () => {
  const [beards, setBeards] = useState([]);
  const protectionRef = doc(db, 'features', 'beard'); // Firestore path
  ...
  // Fetch beard types from Firestore on component load
  useEffect(() => {
